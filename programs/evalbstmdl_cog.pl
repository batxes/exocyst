...
#evaluate the 100 best scores for constraints satisfaction
$cnt=-1;
...
last if ($nnurm==200);
 ...
 open (SAT,"perl ./programs/evalmdl_cog.pl $s |");
...
#system "rm chimeraEval.py chimeraEval.pyc";
