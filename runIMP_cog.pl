...
die "USAGE: ./runIMP.pl cluster_file nbr_iterat\n" unless (-e "$df[0]/$df[1]");
...
#open (IMP,"python exocyst_sec2prt.py |");
open (IMP,"python cog.py |");
#system ("python exocyst_prt_March2013_app1.py > log.txt");
