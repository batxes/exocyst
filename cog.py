...
rep = restrainer.add_representation('input/repr_cog_rdm.xml')
rsr = restrainer.add_restraint('input/restraint_cog.xml')
opt = restrainer.add_optimization('input/optimization.xml')
disp = restrainer.add_display('input/displ_cog.xml')
